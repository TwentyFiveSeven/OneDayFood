...
for i in range(5,840) :
    ...
    try:
        ...
        #   cur.execute("INSERT INTO food_info VALUES ("+str(k)+","+"'"+name.text.strip()+"'"+","+"'"+Nlist[j]+"'"+","+"'"+Nlist[j+1]+"'"+","+"'"+Nlist[j+2]+"'"+","+"'"+Nlist[j+3]+"'"+","+"'"+Nlist[j+4]+"'"+","+"'"+Nlist[j+5]+"'"+","+"'"+Nlist[j+6]+"'"+","+"'"+Nlist[j+7]+"'"+","+"'"+Nlist[j+8]+"'"+","+"'"+Nlist[j+9]+"'"+");")
            j+=10
            k+=1
            print(k)
    except :
